# Store Client - Интернет-магазин одежды
...
│   ├── client-store-logo.ico  # Иконка сайта
│   ├── client-store-logo.svg  # Логотип
│   └── logo-for-pwa.svg      # PWA иконка
├── src/
...
**Store Client** - современный интернет-магазин с полным функционалом электронной коммерции, построенный на передовых технологиях веб-разработки.